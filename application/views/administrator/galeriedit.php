...
<section id="services" class="services">
      ...
      <ol class="breadcrumb" >
        ...
        <li class="breadcrumb-item active">Edit Daftar galeri</li>
      </ol>
...
<div class="card mb-3">
        ...
        <form method="post" enctype="multipart/form-data" action="<?php echo base_url(); ?>administrator/action_galeriupdate">
